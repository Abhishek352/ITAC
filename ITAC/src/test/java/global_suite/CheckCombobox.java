...
public class CheckCombobox extends JFrame {
	...
	public static JPanel createcombo(String labelname, ArrayList<String> options, CheckCombobox obj,
		...
		//checkCombo.setOpaque(true);
		checkCombo.setFocusable(false);
		checkCombo.setBounds(0, 25, 290, 20);
